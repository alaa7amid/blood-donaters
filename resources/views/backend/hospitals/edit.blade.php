                            ...
                            <div class="card-body">
                                <form action="{{ route('hospitals.update',$hospital->id) }}" method="POST">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="hospital" value="{{$hospital->hospital}}" id="name" class="form-control" placeholder="Enter hospital name" required>
                                        @error('name')
                                    ...
                                    <div class="form-group text-right">
                                        <button type="submit" class="btn btn-primary">Update Hospitals Name</button>
                                    </div>
                                </form>
                            </div>
                        </div> <!-- / .card -->
